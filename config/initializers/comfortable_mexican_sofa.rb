...
#ComfortableMexicanSofa::AccessControl::AdminAuthentication.username = 'administrator'
#ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = 'testpass'
